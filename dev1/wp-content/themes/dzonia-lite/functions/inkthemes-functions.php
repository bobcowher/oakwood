...
//Load languages file
load_theme_textdomain('slice', get_template_directory() . '/languages');
$locale = get_locale();
...
function inkthemes_register_custom_menu() {
    register_nav_menu('custom_menu', __('Main Menu', 'dzonia'));
}
...
function inkthemes_new_nav_menu_items($items) {
    if (is_home()) {
        $homelink = '<li class="current_page_item">' . '<a href="' . home_url('/') . '">' . __('Home', 'dzonia') . '</a></li>';
    } else {
        $homelink = '<li>' . '<a href="' . home_url('/') . '">' . __('Home', 'dzonia') . '</a></li>';
    }
...
function inkthemes_breadcrumbs() {
    ...
    if (get_query_var('paged')) {
        if (is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author())
            echo ' (';
        echo __('Page','dzonia') . ' ' . get_query_var('paged');
        if (is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author())
            echo ')';
    }
    echo '</div>';
...
// print "<a href='$permalink'><img src='$first_img' class='postimg wp-post-image' alt='$the_title' /></a>";
        ...
        print "<img src='$first_img' width='592px' height='276px' class='postimg wp-post-image' alt='$the_title' />";
    }
}
/* ----------------------------------------------------------------------------------- */
...
// Retrieves tag list of current post, separated by commas.
    ...
    if ($tag_list) {
        $posted_in = __('This entry was posted in %1$s and tagged %2$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'dzonia');
    } elseif (is_object_in_taxonomy(get_post_type(), 'category')) {
        $posted_in = __('This entry was posted in %1$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'dzonia');
    } else {
        $posted_in = __('Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'dzonia');
    }
...
// Area 1, located at the top of the sidebar.
    register_sidebar(array(
        'name' => __('Primary Widget Area', 'dzonia'),
        'id' => 'primary-widget-area',
        'description' => __('The primary widget area', 'dzonia'),
        'before_widget' => '',
        'after_widget' => '',
...
// Area 2, located below the Primary Widget Area in the sidebar. Empty by default.
    register_sidebar(array(
        'name' => __('Secondary Widget Area', 'dzonia'),
        'id' => 'secondary-widget-area',
        'description' => __('The secondary widget area', 'dzonia'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h2 class="sidebar_title">',
        'after_title' => '</h2>',
	...
	register_sidebar( array(
		'name' => __( 'First Footer Widget Area', 'dzonia' ),
		'id' => 'first-footer-widget-area',
		'description' => __( 'The first footer widget area', 'dzonia' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h4>',
		'after_title' => '</h4>',
	...
	register_sidebar( array(
		'name' => __( 'Second Footer Widget Area', 'dzonia' ),
		'id' => 'second-footer-widget-area',
		'description' => __( 'The second footer widget area', 'dzonia' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h4>',
		'after_title' => '</h4>',
	...
	register_sidebar( array(
		'name' => __( 'Third Footer Widget Area', 'dzonia' ),
		'id' => 'third-footer-widget-area',
		'description' => __( 'The third footer widget area', 'dzonia' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h4>',
		'after_title' => '</h4>',
	...
	register_sidebar( array(
		'name' => __( 'Fourth Footer Widget Area', 'dzonia' ),
		'id' => 'fourth-footer-widget-area',
		'description' => __( 'The fourth footer widget area', 'dzonia' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<h4>',
		'after_title' => '</h4>',
