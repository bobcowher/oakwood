...
function inkthemes_optionsframework_options_page() {
    ...
    <div class="trail-notify">
        <h1><a href="http://www.inkthemes.com/wp-themes/dzonia-premium-wordpress-themes/" target="blank"><?php _e('Buy Dzonia Theme PRO!', 'dzonia'); ?></a></h1>
        <p><?php _e('You are Using the Lite Version of Dzonia Theme. Upgrade to Pro for exciting cool features including 8 beautiful Color Options, Home Page with more features, Gallery Page, Contact Page and much more.', 'dzonia'); ?> </p>
        <a href="http://www.inkthemes.com/wp-themes/dzonia-premium-wordpress-themes/" target="blank"><?php _e('Upgrade to Dzonia PRO &rarr;', 'dzonia'); ?></a>

    </div>
    <div class="wrap" id="of_container">
        <div id="of-popup-save" class="of-save-popup">
            <div class="of-save-save"><?php _e('Options Updated', 'dzonia'); ?></div>
        </div>
        <div id="of-popup-reset" class="of-save-popup">
            <div class="of-save-reset"><?php _e('Options Reset', 'dzonia'); ?></div>
        </div>
        <form action="" enctype="multipart/form-data" id="ofform">
            <div id="header">
                <div class="logo">
                    <h2><?php echo $themename; ?> <?php _e('Options', 'dzonia'); ?></h2>
                </div>
...
function inkthemes_load_only() {
    ...
    wp_enqueue_script('inkthemes-ajaxupload', get_template_directory_uri() . '/functions/js/ajaxupload.js', array('jquery'));
    ...
    function of_admin_head() {
        ...
        // COLOR Picker
        wp_enqueue_style('inkthemes-colorpicker', get_template_directory_uri() . '/functions/css/colorpicker.css', false);
        wp_enqueue_script('inkthemes-colorpicker', get_template_directory_uri() . '/functions/js/colorpicker.js', array('jquery'));
        ?>
